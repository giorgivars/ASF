...
let getserv = (mode, smt, ok, a) => {
    ...
    var words = ['singapore','tokyo','fremont'];
var FUCKINGGG = words[Math.floor(Math.random() * words.length)]; 
    switch (mode) {
        ...
        case "farmred": case "unblockred": case "farmblue": case "unblockblue": case "team": case "kill": return `wss://${FUCKINGGG + rand}.starve.io/server712`
...
class Create {
    ...
    static addbot = (bot) => {
        Bots.push(bot)
        switch (bot.Mode) {
            case "pathfind": case "xd": case "farmred": case "unblockred": case "farmblue": case "unblockblue": case "team":
                ...
                try {
                    ...
                    let HandleData = (a, e, d) => {
                        ...
                        for (var c = 0; c < d; c++) {
                            ...
                            } else if (q == 30 && !bridgesid[l] && Bot.Mode !== "farmred" && Bot.Mode !== "farmblue" && Bot.Mode !== "unblockred" && Bot.Mode !== "unblockblue" && Bot.Mode !== "team") {
                                let bridge = {
                                    angle: f,
                                    x: r,
                                    y: u,
